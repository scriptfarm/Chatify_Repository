...
public class Act_Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.userName = intent.getStringExtra(Act_Login.EXTRA_USERNAME);
        this.serverAddress = intent.getStringExtra(Act_Login.EXTRA_SERVERIP);

        try{
            this.serverPort = Integer.parseInt(intent.getStringExtra(Act_Login.EXTRA_SERVERPORT));
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //Setting the content for the displayed swap pages
            View rootView = inflater.inflate(R.layout.layout_generalchat, container, false);
