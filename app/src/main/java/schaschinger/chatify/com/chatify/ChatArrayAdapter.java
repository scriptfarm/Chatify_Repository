...
public class ChatArrayAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public ChatArrayAdapter(Context context, int textViewResourceId) {
        //Context is the environment in which the class operates
        //textViewResourceId describest the View which the ArrayAdapter provides information
    ...
    public View getView(int position,View ConvertView, ViewGroup parent){
        ...
        if(v==null){
            ...
            /*
            Instantiates a layout XML file into its corresponding View objects. It is never used directly. Instead, use getLayoutInflater() or getSystemService(Class)
        ...
        chatText.setBackgroundResource(messageobj.left ? R.drawable.speech_bubble_orange :R.drawable.speech_bubble_green);
